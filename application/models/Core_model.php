...
defined('BASEPATH') OR exit('Ops! Ação não permitida');
...
class Core_model extends CI_Model {
	...
	public function insert($tabela = null, $data = null, $get_last_id = null) {
		...
		if($tabela && $this->db->table_exists($tabela)  && is_array($data)) {
			...
			//Se get_last_id veio como parametro, então será inserido na sessão o último ID criado no banco de dados de $tabela
