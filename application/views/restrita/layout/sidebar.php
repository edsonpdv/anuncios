<div class="page-sidebar sidebar"> <!-- Inicio Sidebar -->
                <div class="page-sidebar-inner slimscroll">
					...
					<a href="<?php echo base_url('restrita/usuarios'); ?>" class="waves-effect waves-button"><span class="menu-icon icon-user"></span><p>Usuários</p><span class="active-page"></span></a></li>
